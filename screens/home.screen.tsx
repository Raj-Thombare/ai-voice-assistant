          ...
          messages: [
            {
              role: "system",
              content:
                "You are BuddyAI, a friendly AI assistant who responds naturally and referes to yourself as BuddyAI when asked for your name. You are a helpful assistant who can answer questions and help with tasks. You must always respond in English, no matter the input language,and provide helpful, clear answers",
            },
            {
              role: "user",
              content: text,
